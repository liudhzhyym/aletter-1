//
//  MOLDeleteCommentViewController.m
//  aletter
//
...
@interface MOLDeleteCommentViewController ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation MOLDeleteCommentViewController
...
- (void)viewDidLoad {
    ...
    self.nameArray = @[@"删除评论",@"我手滑了"];
    [self setupDeleteCommentViewControllerUI];
...
{
    // 删除接口
    MOLActionRequest *r = [[MOLActionRequest alloc] initRequest_deleteActionCommentWithParameter:nil parameterId:self.commentModel.commentId];
...
#pragma mark - UI
- (void)setupDeleteCommentViewControllerUI
{
...
- (void)calculatorDeleteCommentViewControllerFrame
{
...
- (void)viewDidLayoutSubviews
{
    ...
    [self calculatorDeleteCommentViewControllerFrame];
}
@end
