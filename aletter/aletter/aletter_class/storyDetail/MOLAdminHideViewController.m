...
@interface MOLAdminHideViewController ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation MOLAdminHideViewController
...
- (void)button_clickDeleteButton
{
    ...
    [r baseNetwork_startRequestWithcompletion:^(__kindof MOLBaseNetRequest *request, MOLBaseModel *responseModel, NSInteger code, NSString *message) {
        if (code == MOL_SUCCESS_REQUEST) {
            if (self.adminHideStoryBlock) {
                self.adminHideStoryBlock();
            }
