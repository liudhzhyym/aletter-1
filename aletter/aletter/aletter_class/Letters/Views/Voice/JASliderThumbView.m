...
- (void)drawRect:(CGRect)rect {
    ...
    // 矩形
    CGContextAddRect(context,CGRectMake((self.diameter-self.stickWidth)/2.0, self.diameter/2.0, self.stickWidth, self.frame.size.height-self.diameter));
    // 下圆
    CGContextAddEllipseInRect(context, CGRectMake(0, self.frame.size.height-self.diameter, self.diameter, self.diameter));
