...
//#define MOL_Green 0x6BD379 //进度条颜色
#define MOL_Green 0xFFFFFF //进度条颜色
@interface MOLWebViewController ()<WKUIDelegate, WKNavigationDelegate, UIGestureRecognizerDelegate, JAScriptMessageHandler>
@property (nonatomic, strong) WKWebView *webView;
@property (nonatomic, strong) UIProgressView *progressView;
@property (nonatomic, strong) UIBarButtonItem *backItem;
@property (nonatomic, strong) UIBarButtonItem *closeItem;
@property (nonatomic, assign) BOOL isNotFirstLoad;
@property (nonatomic, strong) MOLJSBridgeHelper *jsHelper;
...
- (void)viewDidLoad {
    ...
    self.jsHelper = [MOLJSBridgeHelper new];
...
- (void)setupProgressView {
    ...
    self.progressView.tintColor = HEX_COLOR(MOL_Green);
...
- (void)setupNaviBar{
    ...
    UIBarButtonItem *backItem = [[UIBarButtonItem alloc] initWithImage:[[UIImage imageNamed:@"back"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] style:UIBarButtonItemStyleDone target:self action:@selector(clickedBackItem:)];
    ...
    UIBarButtonItem *shareItem = [[UIBarButtonItem alloc] initWithImage:[[UIImage imageNamed:@"三个点"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] style:UIBarButtonItemStyleDone target:self action:@selector(shareItem:)];
...
//分享
- (void)shareItem:(UIBarButtonItem *)btn{
    
    [self.jsHelper initiateH5Share];
