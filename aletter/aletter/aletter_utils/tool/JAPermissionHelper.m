            ...
            [audioSession performSelector:@selector(requestRecordPermission:) withObject:^(BOOL granted) {
                if (granted) {
                    ...
                    dispatch_async(dispatch_get_main_queue(), ^{
                        UIAlertController *alertController = [UIAlertController alertControllerWithTitle:@"有封信想要访问您的麦克风" message:nil preferredStyle:UIAlertControllerStyleAlert];
                        UIAlertAction *cancel = [UIAlertAction actionWithTitle:@"不允许" style:UIAlertActionStyleCancel handler:nil];
 ...
 *  获取麦克风权限
 */
+ (void)systemPermissionsWithVoice_getSuccess:(void(^)(void))success getFailure:(void(^)(void))failure
{
