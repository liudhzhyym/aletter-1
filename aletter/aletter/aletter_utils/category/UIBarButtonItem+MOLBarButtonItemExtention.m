...
+ (UIBarButtonItem *)mol_barButtonItemWithTitleName:(NSString *)titleName targat:(id)targat action:(SEL)action
{
    ...
    [item setTitleTextAttributes:@{NSFontAttributeName : [UIFont systemFontOfSize:14],NSForegroundColorAttributeName : HEX_COLOR_ALPHA(0xffffff, 0.7)} forState:UIControlStateDisabled];
    return item;
}
